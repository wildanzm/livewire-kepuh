    ...
    <ul class="space-y-2 font-medium">    
        <li>
            <a href="#"
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Permintaan Surat</span>
                <span
                    class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-700 dark:text-blue-300">3</span>
            </a>
        </li>
        <li>
            <button type="button"
            ...
            <ul id="dropdown-layouts" class="hidden py-2 space-y-2">
                ...
                <li>
                    <a href=""
                        class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Surat Domisili</a>
                </li>
                <li>
                    <a href=""
