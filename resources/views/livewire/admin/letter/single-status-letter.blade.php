                                ...
                                @foreach ($requests as $request)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td
                                            ...
                                            {{ $request->singleStatusLetter->name ?? 'Data tidak tersedia' }}
                                        </td>
                                        <td
                                            class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            {{ $request->singleStatusLetter->name }}
                                        </td>
                                        <td
                                            class="p-4 text-base font-medium text-gray-900 break-words whitespace-normal dark:text-white">
                                            {{ $request->singleStatusLetter->number_letter ?? 'Belum ada nomor surat. Edit data untuk menambahkan nomor surat.' }}
                                        </td>
                                        <td class="p-4 space-x-2 whitespace-nowrap">
                                            <div class="flex flex-col gap-3">
                                                @if ($request->singleStatusLetter)
                                                    ...
                                                    <a href=" {{ route('admin.single-status-letter.streamPDF', $request->singleStatusLetter->id) }}"
                                                    ...
                                                    <a href="  {{ route('admin.single-status-letter.edit', $request->singleStatusLetter->id) }}"
