                                ...
                                @foreach ($requests as $request)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td
                                            ...
                                            {{ $request->maritalStatusLetter->name ?? 'Data tidak tersedia' }}
                                        </td>
                                        <td
                                            class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            {{ $request->maritalStatusLetter->name }}
                                        </td>
                                        <td
                                            class="p-4 text-base font-medium text-gray-900 break-words whitespace-normal dark:text-white">
                                            {{ $request->maritalStatusLetter->number_letter ?? 'Belum ada nomor surat. Edit data untuk menambahkan nomor surat.' }}
                                        </td>
                                        <td class="p-4 space-x-2 whitespace-nowrap">
                                            <div class="flex flex-col gap-3">
                                                @if ($request->maritalStatusLetter)
                                                    <a href="  {{ route('admin.marital-status-letter.download', $request->maritalStatusLetter->id) }}"
                                                    ...
                                                    <a href="{{ route('admin.marital-status-letter.streamPDF', $request->maritalStatusLetter->id) }} "
                                                    ...
                                                    <a href="  {{ route('admin.marital-status-letter.edit', $request->maritalStatusLetter->id) }}"
