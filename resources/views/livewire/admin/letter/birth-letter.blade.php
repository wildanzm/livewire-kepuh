    ...
    <div>
        <div
            ...
            <div class="w-full mb-1">
                <div class="mb-4">
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Permintaan Surat Akta
                        Kelahiran
                    </h1>
                </div>
                <div>
                                ...
                                @foreach ($requests as $request)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td
                                            ...
                                            {{ $request->birthLetter->reporter_name ?? 'Data tidak tersedia' }}
                                        </td>
                                        <td
                                            class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        ...
                                        <td
                                            ...
                                            {{ $request->birthLetter->number_letter ?? 'Belum ada nomor surat. Edit data untuk menambahkan nomor surat.' }}
                                        </td>
                                        <td class="p-4 space-x-2 whitespace-nowrap">
                                            <div class="flex flex-col gap-3">
                                                ...
                                                @if ($request->birthLetter)
                                                    <a href="{{ route('admin.birth-letter.download', $request->birthLetter->id) }}"
                                                    ...
                                                    <a href="{{ route('admin.birth-letter.streamPDF', $request->birthLetter->id) }}"
                                                    ...
                                                    <a href="{{ route('admin.birth-letter.edit', $request->birthLetter->id) }}"
