<div class="max-w-4xl mx-auto my-6  bg-white shadow-xl p-8  rounded-xl ">
    ...
    <form wire:submit.prevent="update">
        @foreach ([['number_letter', 'Nomor Surat', 'number'], ['name', 'Nama', 'text'], ['nik', 'NIK', 'number'], ['birth_date', 'Tanggal Lahir', 'date'], ['nationality', 'Kewarganegaraan', 'text'], ['religion', 'Agama', 'text'], ['occupation', 'Pekerjaan', 'text'], ['address', 'Alamat', 'textarea']] as $field)
            <div class="mb-4">
                <label for="{{ $field[0] }}"
