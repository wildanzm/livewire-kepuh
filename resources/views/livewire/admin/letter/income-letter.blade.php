                                ...
                                @foreach ($requests as $request)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td
                                            ...
                                            {{ $request->incomeLetter->name ?? 'Data tidak tersedia' }}
                                        </td>
                                        <td
                                            class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        ...
                                        <td
                                            ...
                                            {{ $request->incomeLetter->number_letter ?? 'Belum ada nomor surat. Edit data untuk menambahkan nomor surat.' }}
                                        </td>
                                        <td class="p-4 space-x-2 whitespace-nowrap">
                                            <div class="flex flex-col gap-3">

                                                @if ($request->incomeLetter)
                                                    <a href="{{ route('admin.income-letter.download', $request->incomeLetter->id) }}"
                                                    ...
                                                    <a href="{{ route('admin.income-letter.streamPDF', $request->incomeLetter->id) }}"
                                                    ...
                                                    <a href="{{ route('admin.income-letter.edit', $request->incomeLetter->id) }}"
